...
<%--<h1>Hello</h1>--%>
<%--<h1><a href="demo/MusicDemo.jsp">demo</a></h1>--%>
<%--<%Integer a = 8;%>--%>
<%--<h1>salom <%=a%></h1>--%>
<%--<audio controls>--%>
<%--    <source src="audios/1659244312351.mp3" type="audio/mp3">--%>
<%--</audio>--%>
<%--<audio controls>--%>
<%--    <source src="audios/Powerful-Emotional-Trailer.mp3" type="audio/mp3">--%>
<%--</audio>--%>
...
<%--                              data-src="${pageContext.request.contextPath}/audios/${music.file.generatedName}">${music.file.originalName}</span><span--%>
<%--                            class="simp-desc">Asliddin</span></li>--%>
                        <%--                <li><span class="simp-source"--%>
                        <%--                          data-src="https://www.script-tutorials.com/demos/363/data/05.mp3">Artist 5</span></li>--%>
                        ...
                        <%--                                              data-src="https://www.dropbox.com/s/k011ag91uktonbv/Angklung%20Preman%20Pensiun.mp3?dl=1">Angklung Preman Pensiun</span>--%>
                        <%--                </li>--%>
                        <%--                <li><span class="simp-source"--%>
                        <%--                          data-src="https://www.dropbox.com/s/prgte33m86n9ce7/Canon%20Rock%20%28JerryC%29%20-%20funtwo.mp3?dl=1">Canon Rock (JerryC)</span><span--%>
                        <%--                        class="simp-desc">by Funtwo</span></li>--%>
