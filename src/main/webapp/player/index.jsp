...
<body>
<!-- <header class="intro">-->
<!-- <h1>Audio Player with Playlist Example </h1>-->
<!-- <p> HTML5 Audio Player with playlist and sustom controls.</p>-->

<!-- <div class="action">-->
<!-- <a href="https://www.codehim.com/vanilla-javascript/javascript-audio-player-with-playlist/" title="Back to download and tutorial page" class="btn back">Back to Tutorial</a>-->
<!-- </div>-->
<!-- </header>-->
<!--  -->
<!--      -->
            ...
            <c:forEach items="${musics}" var="music">
                <ul>
                    <li><span class="simp-source"
                            ...
                            class="simp-desc">${music.author}</span></li>
                </ul>
            </c:forEach>
        </div>
...
*/
    ...
    if (document.querySelector('#simp')) {
        var simp_auto_load, simp_audio, simp_album, simp_cover, simp_title, simp_artist, simp_controls, simp_progress,
            simp_volume, simp_v_slider, simp_v_num, simp_others;
